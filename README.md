...
- **AI Service Integration** ? Pluggable AI service (Ollama or demo provider) that auto-generates course descriptions, topic lists, difficulty levels, and duration estimates when uploading courses from the admin dashboard.But a better ai api needed.
